...
Route::group(["middleware" => "auth:api"], function () {
    ...
    //Roles
    Route::post('add-role', [PermissionController::class, 'addPermission']);
    Route::get('all-roles', [PermissionController::class, 'allPermissions']);
    Route::post('update-role/{id}', [PermissionController::class, 'updatePermission']);
    Route::post('delete-role/{id}', [PermissionController::class, 'deletePermission']);
});
